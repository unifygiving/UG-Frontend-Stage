...
export default function ImpactExistingUser({ navigation }) {
          ...
          <View flexDirection="column" flex={7}>
            ...
            <View flex={0.2}>
              <Text style={{ fontWeight: '700', fontSize: 16 }}>
                Congrats! You’re in the Top 23% of donors this month.
              </Text>
            </View>
            <View flex={0.1}>
              <Card mode="elevated" style={{ margin: 15, marginBottom: 5 }}>
                <Card.Title
                  ...
                  left={() => (
                    <List.Icon icon="heart-outline" color="#6200ee" />
                  )}
                  onPress={() => {
            ...
            <View flex={0.5}>
              <Button
                ...
                onPress={() => {
                  navigation.navigate('ImpactExistingUser');
                }}
              >
                Donate Now
              </Button>
