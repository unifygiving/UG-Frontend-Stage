...
import { useGetSumDonationsByDonorIdRTKQuery, useGetDonationImpactResultsQuery } from "../../store/slices/donationSlice.js";
...
const Impact = ({ navigation }) =>
{
    ...
    const { data: impactResults, refetch: refetchImpactResults, isFetching: isFetchingImpactResults } 
        ...
        <ScrollView style={[{ width, height }, { backgroundColor: COLOURS.white }]}>
            <View style={styles.container}>
                    ...
                    <Card.Content style={{ paddingHorizontal: 0, paddingVertical: 0 }}>
                        <View>
                            <Text style={styles.headerText}>
                                ...
                                {t("amountOfCharitiesHeader")} {renderCountryMap(showMap, false, false)}</Text>
                        </View>
                    </Card.Content>
                </Card>
                ...
                <View style={styles.infoContainer}>
                    <Card style={[styles.info, { marginBottom: 10 }]} mode='contained'>
                        <Card.Content style={{ flexDirection: 'row', alignItems: 'center', paddingHorizontal: 0, paddingVertical: 0 }}>
                            ...
                            <View style={{ marginLeft: 24 }}>
                                <Text style={textInfo}>{t("beneficiariesCountTitle")}</Text>
                                <Text style={amountInfo}>{impactResults?.UgTotalHelpedRecipientsCount}</Text>
                            </View>
                        </Card.Content>
                    </Card>
                    ...
                    <Card mode='contained'>
                        <View style={styles.textContainer} mode='contained'>
                            <Card.Title titleStyle={styles.title} title={t("witnessTitle")} titleNumberOfLines={2} />
                            <Text style={styles.text}>
                                {t("witnessMessage")}
                            </Text>
                        </View>
                        <Card.Actions style={{ marginVertical: 20 }}>
                            <MainButton
                                nameBtn={t("btnContinueTitle")}
